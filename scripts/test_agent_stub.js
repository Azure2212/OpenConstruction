...
(function () {
  ...
  check('exposes exactly the primitive toolset (23)', JSON.stringify(names) === JSON.stringify(['assess_training_readiness', 'check_access', 'check_fitness', 'check_license', 'compare_resources', 'convert_annotations', 'create_dataset_split', 'detect_format', 'get_citation', 'get_dataset', 'inventory_files', 'list_tasks', 'prepare_training_config', 'profile_annotations', 'profile_bim', 'profile_images', 'profile_pointcloud', 'profile_table', 'recommend_benchmark', 'resolve_url', 'search_datasets', 'submit_answer', 'validate_metadata']), names);
